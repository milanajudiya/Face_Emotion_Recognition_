...
def main():
    ...
    if page_name == 'Home':
        ...
        st.write("Click on start to use a webcam and to detect your Face Emotion.")
        rtc_configuration=RTCConfiguration({"iceServers": [{"urls": ["stun:stun.l.google.com:19302"]}]})
        webrtc_streamer(key="example", video_processor_factory=VideoTransformer, media_stream_constraints={"video": True,"audio": False}, rtc_configuration =  rtc_configuration
)
        ...
        brain rather translated in numbers that can be analysed and tracked. The solution to this problem is by recognizing Facial Emotions. This is a live face emotion detection system. The model is able to real-time identify the emotions of students in a live class.<p>
        <body>'''
        st.markdown(statement_html,True)
        st.write("Contact Details:")
        st.write("Milan Ajudiya")
